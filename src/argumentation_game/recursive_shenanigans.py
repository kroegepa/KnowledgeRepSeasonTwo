...
def recursive_boogaloo(argument_graph: ArgumentGraph, labeling: List[int], current_node: int)-> Optional[list] :
    if labeling[current_node] == 1:
        ...
        if changed_flag == 0:
            return labeling
        for attacker in argument_graph.arguments[current_node].attackers:
            recursive_boogaloo(argument_graph,labeling,attacker)
#If current_node is out
        ...
        for attacker in argument_graph.arguments[current_node].attackers:
            ...
            if labeling[attacker] == 2:
                ...
                temp_labeling = recursive_boogaloo(argument_graph,temp_labeling, attacker)
